...
$page_nav["project"]["sub"]["allproject"]["active"] = true;
include("inc/nav.php");
								...
								<table id="datatable_tabletools" class="table table-striped table-hover">
									<thead>
										<tr>
											...
											<!--<th>Customer <br>Information and <br>Requirement</th>
											<th>Pre-Project <br>Value <br>Creation</th> -->
											<th>Proposal</th>
											<th>Project <br>Impact <br>Matrix</th>
											<th>Status</th>
											<th>Action</th>
										</tr>
									</thead>
									...
									{	
										...
										{	
											$submission = "<a href=\"choose.php?projectid=$projectid\"><font color=\"74E059\"><strong>Ready to Submit</strong></font></a>";
										}
										else
										{	
										...
										if ($reviewer != '')
										{
											$submission = "<font color=\"32A3D3\"><strong>Submitted</strong></font>";
										}
										
										if ($manager_status != '')
										{
											$submission = $manager_status;
											$submission = "<a href=\"remark.php?projectid=$projectid\"><font color=\"32A3D3\"><strong>$manager_status</strong></font></a>";
										}
									...
									?>
										...
										<!--<td><a href="cir.php?track=<?php echo $projectid; ?>"><?php echo $cir_status; ?></a></td>
											...
											<td><a href="delete.php?track=<?php echo $projectid; ?>"><font color="708090"><strong>Delete</strong></font></a></td>
										</tr>
									<?php } ?>
									</tbody>
								</table>
