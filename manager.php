								...
								<table id="datatable_tabletools" class="table table-striped table-hover">
									<thead>
										<tr>
											...
											<th>Project Name</th>
											<th width=10%>ID</th>
											<th>Product Initiation</th>
											<th>Customer <br>Information and <br>Requirement</th>
											<th>Project <br>Value <br>Creation</th>
											<th>Proposal</th>
									...
									<tbody>
									<?php
									$q = "SELECT * FROM project WHERE reviewer = '$username'";
									...
									{	
										...
										if ($reviewer != '')
										{
											$submission = "<a data-toggle=\"modal\" href=\"choose_manager.php?projectid=$projectid\"><font color=\"32A3D3\"><strong>Submitted</strong></font></a>";
										}
